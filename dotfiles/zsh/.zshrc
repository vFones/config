...
# Example aliases
    ...
    alias etcher="/usr/bin/Etcher.AppImage"
    alias upgrade="sudo apt update && sudo apt upgrade"
    alias startoracle="sudo docker start oracle11 && ssh root@localhost -p 49160"
    alias stoporacle="sudo docker stop oracle11"
    alias dockerstatus="sudo docker ps -a"
# Powerline theme configuration

   POWERLEVEL9K_MODE='nerdfont-patched'

#Path to your oh-my-zsh installation.
	export ZSH=/home/at0m/.oh-my-zsh
...
# CORRECT PATH
    ...
    export JAVA_HOME
    export PATH
    export NETKIT_HOME=/home/at0m/Documenti/RETI/netkit
    export MANPATH=:$NETKIT_HOME/man
    export PATH=/home/at0m/Documenti/RETI/netkit/bin:$PATH
